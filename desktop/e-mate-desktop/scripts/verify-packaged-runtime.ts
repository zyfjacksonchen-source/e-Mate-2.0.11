...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'build/e-mate-profile/browser-extension/manifest.json',
  'build/e-mate-profile/browser-extension/background.js',
  'build/e-mate-profile/browser-extension/content.js',
  'build/e-mate-profile/browser-extension/panel/index.html',
  'lib/main.js',
  'lib/client.js',
  'lib/index.js',
  'lib/profile.js',
