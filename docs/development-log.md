...
- Verification commands and results: Node 24 分类器 `25/25`、组件闭包 `9 passed / 4 toolchain-absent skipped`、Profile 组合/发布 `4 passed / 1 toolchain-absent skipped`，`git diff --check` 通过；受保护 CI 仍待提交后执行。
