...
3. Run T06, T07, T09, T10, T14 and T15 in dependency-safe waves within the executor cap.
...
- Image: generate 1/2/4/8; edit uploaded/current-session/reopened-session images; independent edits versus explicit fusion; one 429, timeout and invalid response; partial success; cancel; unknown result; `imagen` discovery; source/output SHA inequality; semantic verification does not accept the worker's prose.
