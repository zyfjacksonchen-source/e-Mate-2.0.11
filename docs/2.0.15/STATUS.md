...
| T18 | Freeze/RC/release | 5.6 sol max / xhigh | `release/2.0.15` | source phase: every product P0 `MERGED`; candidate/installed gates stay inside T18 | `worktrees/emate-2.0.15-release` | `NARROW_TEST_PASSED` | same visible task `01a0447b-214f-7050-a85f-76b50ecffc8a`; source freeze `c2e7365`, source-gate correction `7a6703c`, evidence tip `bc68896`; `docs/2.0.15/evidence/T18.json`; Build once through formal release remain open |
