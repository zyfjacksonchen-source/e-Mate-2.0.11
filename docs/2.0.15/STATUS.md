...
| T06 | Native Schedule closure and `@定时任务` source | 5.6 sol max / xhigh | `feat/2.0.15-T06-schedules-e2e` | T02 harness; T05 visibility | `worktrees/emate-2.0.15-T06` | `TODO` | `docs/2.0.15/evidence/T06.json` |
