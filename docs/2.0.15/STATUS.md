...
| T11 | Home/Account/Token heatmap and Shell token/host seam | 5.6 sol / high | `feat/2.0.15-T11-home-settings` | T06 extraction; T10 schema | `worktrees/emate-2.0.15-T11` | `INVESTIGATED` | visible task `01a0436a-de49-7ad1-a576-b4198616aa5e`; `103833c` removed the negative patch and committed CP-11/12 but failed D013 review because the Host attribute was still document-scan-owned; exact native-owner correction active before T16 |
