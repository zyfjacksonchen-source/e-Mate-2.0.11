...
| T11 | Home/Account/Token heatmap and Shell token/host seam | 5.6 sol / high | `feat/2.0.15-T11-home-settings` | T06 extraction; T10 schema | `worktrees/emate-2.0.15-T11` | `INVESTIGATED` | visible audit `01a0436a-de49-7ad1-a576-b4198616aa5e` reopened D012: negative frame patch and temporary CP-11/CP-12 extension must be replaced before T16 |
