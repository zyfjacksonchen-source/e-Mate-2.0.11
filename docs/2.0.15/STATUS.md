...
| T15 | Runtime plugins/connectors, Computer Use availability and native image intake | 5.6 sol max / high | `feat/2.0.15-T15-runtime-components` | T03 audit; T05 routing; T10 model-capability contract | `worktrees/emate-2.0.15-T15` | `INVESTIGATED` | release commits `8cd64e9`, `f99cbdc`, `f3ec2ca` remain merged; D016 reopens the same visible task `01a0436a-de49-7ad1-a576-b3df10972f5c` only for the missing native Computer Use capability projection before T13 can merge; clean-fetch proof remains T18 |
