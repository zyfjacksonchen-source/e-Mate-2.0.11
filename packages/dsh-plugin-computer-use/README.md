...
This package embeds the exact MIT-licensed `Anionex/dsh-computer-use` commit recorded in `SOURCE.md` and adapts its bundle identity to e-Mate 2.0.13 on Harness rc.7. It stays on the native DSH Tool, Skill, Settings, approval, storage, attachment, and subprocess seams.
