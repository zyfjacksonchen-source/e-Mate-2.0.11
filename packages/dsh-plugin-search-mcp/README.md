...
Harness `0.1.0-rc.7` service packages are not available from the public npm registry. They are optional peer dependencies here and must resolve from e-Mate's pinned, prebuilt Harness runtime. Do not install rc.6 packages to satisfy them.
