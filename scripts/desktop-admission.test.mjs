...
test('performance evidence and signing use their existing isolated environments', async () => {
  ...
  assert.equal(signer.uses, 'zyfjacksonchen-source/e-mate-desktop-publication/performance@bfe869505196f3124192f6e0c219014c94365639')
...
test('Desktop publication workflow only emits the exact Cloudflare plugin handoff', async () => {
  ...
  assert.equal(invocation.uses, 'zyfjacksonchen-source/e-mate-desktop-publication@bfe869505196f3124192f6e0c219014c94365639')
  ...
  assert.deepEqual(job.steps.filter(step => step.uses).map(step => step.uses), [
    ...
    'zyfjacksonchen-source/e-mate-desktop-publication@bfe869505196f3124192f6e0c219014c94365639',
