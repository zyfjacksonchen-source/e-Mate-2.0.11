...
function fixture() {
  ...
  const baseId = 'e-mate-desktop-profile-v13-dsh-d19aae6da310'
  ...
  execFileSync('git', [
    ...
    '160000,d19aae6da3100e836867418c2cf73bdee8a0b1a8,upstream/deepseek-harness',
  ], { cwd: root })
  execFileSync('git', [
    'update-index', '--add', '--cacheinfo',
  ...
  writeJson(join(root, 'desktop/e-mate-desktop/base-contract.json'), {
    ...
    harness_version: '0.1.0-rc.7',
    harness_commit: 'd19aae6da3100e836867418c2cf73bdee8a0b1a8',
    runtime_imports: {},
  ...
  const components = ['fixture-a', 'fixture-b'].map(slug => {
    ...
    writeJson(join(componentRoot, 'package.json'), {
      ...
      eMate: {
        ...
        harnessCommit: 'd19aae6da3100e836867418c2cf73bdee8a0b1a8',
      },
      license: 'MIT',
    })
