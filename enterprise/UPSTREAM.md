...
This directory contains the smallest server-side subset needed by e-Mate 2.0.9:
...
2.0.9 changes are expected to differ and remain reviewable in this repository.
